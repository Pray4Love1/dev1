...
description: Scan your codebase for exposed blockchain private keys, seed phrases, and API credentials using the Chainstack data leak protection scanning tool.
---
