---
title: "Harmony tooling"
description: Set up MetaMask, Hardhat, Foundry, and other development tools to build and deploy smart contracts on Harmony through Chainstack node endpoints.
---
...
* NETWORK\_ID — Harmony network ID:
...
<Steps>
  ...
  <Step>
   ...
   <CodeGroup>
     ```shell Shell
     brownie networks add Harmony ID name="NETWORK_NAME" host= YOUR_CHAINSTACK_ENDPOINT chainid=NETWORK_ID
     ```
   </CodeGroup>
