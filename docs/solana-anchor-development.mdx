...
description: Build, test, and deploy Solana programs with the Anchor framework — project scaffolding, program structure, account constraints, IDL generation, LiteSVM testing, and client interaction using Anchor 1.0.0.
---
