...
<CardGroup>
  <Card title="Edin Drazevicanin">
    <img src="/images/docs/mudOE4f.jpeg" alt="Edin Drazevicanin" style={{width: '80px', height: '80px', borderRadius: '50%', objectFit: 'cover', display: 'block', margin: '0 auto'}} noZoom />

    <Icon icon="code" iconType="solid" /> Technical Support Engineer @ Chainstack

    [<Icon icon="github" iconType="brands" />](https://github.com/0x6564) [<Icon icon="twitter" iconType="brands" />](https://twitter.com/edeenn22) [<Icon icon="linkedin" iconType="brands" />](https://www.linkedin.com/in/edindr/)
  </Card>
</CardGroup>
