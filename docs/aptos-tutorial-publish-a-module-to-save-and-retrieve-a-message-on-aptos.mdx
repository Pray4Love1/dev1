---
title: "Aptos: Publish a module to save and retrieve messages"
description: Publish a Move module on Aptos that stores and retrieves on-chain messages using the Aptos CLI and a Chainstack node on devnet for deployment.
---
