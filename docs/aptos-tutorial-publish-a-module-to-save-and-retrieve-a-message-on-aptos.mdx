...
description: "Learn to publish Aptos modules with Move language on Chainstack. Step-by-step tutorial covering CLI setup, module creation, compilation, testing, and on-chain interaction."
---
