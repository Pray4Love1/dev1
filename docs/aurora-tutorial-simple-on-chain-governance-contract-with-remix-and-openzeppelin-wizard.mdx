---
title: "Aurora: On-chain governance with Remix & OpenZeppelin"
description: Build a DAO governor, governance token, and mintable ERC-20 on Aurora using Remix and OpenZeppelin Wizard with a Chainstack node endpoint.
---
