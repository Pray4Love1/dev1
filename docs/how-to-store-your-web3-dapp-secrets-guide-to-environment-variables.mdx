---
title: "Web3 dApp secrets: Environment variables guide"
description: Protect private keys, API tokens, and RPC endpoints in Web3 dApps using environment variables, backend proxies, and secret management services.
---
...
<CardGroup>
  <Card title="Petar Stoykov">
    <img src="https://pbs.twimg.com/profile_images/1565444249784565761/J6viLLoe_400x400.jpg" alt="Petar Stoykov" style={{width: '80px', height: '80px', borderRadius: '50%', objectFit: 'cover', display: 'block', margin: '0 auto'}} noZoom />

    <Icon icon="code" iconType="solid" /> Senior Copywriter @ Chainstack
    <br /><Icon icon="screwdriver-wrench" iconType="solid" /> Writes on Ethereum, NFTs, and underlying technology

    <div style={{display: "flex", justifyContent: "center", gap: "12px"}}>
      <a href="https://github.com/petarsrepo" style={{textDecoration: "none", borderBottom: "none"}}><Icon icon="github" iconType="brands" /></a>
      <a href="https://twitter.com/petarcopyrock" style={{textDecoration: "none", borderBottom: "none"}}><Icon icon="twitter" iconType="brands" /></a>
      <a href="https://www.linkedin.com/in/pstoykov/" style={{textDecoration: "none", borderBottom: "none"}}><Icon icon="linkedin" iconType="brands" /></a>
    </div>
  </Card>
  <Card title="Davide Zambiasi">
    <img src="/images/docs/profile_images/1533079085001363457/1VvXp1m0_400x400.jpg" alt="Davide Zambiasi" style={{width: '80px', height: '80px', borderRadius: '50%', objectFit: 'cover', display: 'block', margin: '0 auto'}} noZoom />
    ...
    <div style={{display: "flex", justifyContent: "center", gap: "12px"}}>
      <a href="https://github.com/soos3d" style={{textDecoration: "none", borderBottom: "none"}}><Icon icon="github" iconType="brands" /></a>
      <a href="https://twitter.com/web3Dav3" style={{textDecoration: "none", borderBottom: "none"}}><Icon icon="twitter" iconType="brands" /></a>
      <a href="https://www.linkedin.com/in/davide-zambiasi/" style={{textDecoration: "none", borderBottom: "none"}}><Icon icon="linkedin" iconType="brands" /></a>
    </div>
  </Card>
</CardGroup>
