...
<CardGroup>
  <Card title="Petar Stoykov">
    ...
    [<Icon icon="github" iconType="brands" />](https://github.com/petarsrepo) [<Icon icon="twitter" iconType="brands" />](https://twitter.com/petarcopyrock) [<Icon icon="linkedin" iconType="brands" />](https://www.linkedin.com/in/pstoykov/)
  </Card>
