...
description: "Discover Bun JavaScript runtime with Chainstack. Learn fast server setup, built-in fetch API, TypeScript support, and zero dependencies for Web3 development."
---
