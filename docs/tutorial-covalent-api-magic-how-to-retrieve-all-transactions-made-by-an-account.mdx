---
title: "Covalent API: Retrieve all account transactions"
description: Retrieve all transactions for a blockchain account using the Covalent API through Chainstack Marketplace. Covalent support is now deprecated on Chainstack.
---
