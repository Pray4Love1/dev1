...
description: Connect to the Solana blockchain through the MCP server protocol for AI-assisted development with balance queries, token lookups, and transaction analysis.
---
