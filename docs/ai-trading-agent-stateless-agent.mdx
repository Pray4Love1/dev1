...
description: Build a stateless AI trading agent for independent blockchain market analysis calls with no session memory, ideal for serverless deployment patterns.
---
