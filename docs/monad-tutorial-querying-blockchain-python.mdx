---
title: "Monad: Querying the blockchain with Python"
description: Read blockchain data from Monad using web3.py and a Chainstack node endpoint, covering blocks, transactions, balances, and smart contract state queries.
---
