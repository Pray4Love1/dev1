...
description: "Complete Ethereum Dencun upgrade guide with Chainstack. Learn EIP-4844 blob transactions, EIP-1153 transient storage, beacon block roots, and all Dencun EIPs with examples."
---
...
Use the slot number in a [Retrieve blobs by block ID](/reference/getblobsbyblockid) call to the consensus layer:
