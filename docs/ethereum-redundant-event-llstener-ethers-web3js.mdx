---
title: "Ethereum: Redundant event listener with ethers/web3.js"
description: Build a redundant Ethereum event listener using ethers.js and web3.js with automatic reconnection and failover across multiple Chainstack endpoints.
---
