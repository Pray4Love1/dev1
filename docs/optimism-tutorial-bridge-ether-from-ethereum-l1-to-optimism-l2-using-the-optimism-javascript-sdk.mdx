...
description: "Bridge ether from Ethereum L1 to Optimism L2 using JavaScript SDK and Chainstack. Learn CrossChainMessenger, deposit ETH, wait for relay status, and check balances."
---
