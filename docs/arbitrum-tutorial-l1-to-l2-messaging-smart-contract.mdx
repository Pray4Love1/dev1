...
description: Send cross-chain messages from Ethereum L1 to Arbitrum L2 using the Arbitrum SDK and Chainstack nodes with a smart contract deployed via Hardhat.
---
