...
description: "Learn Solana blocks vs slots concepts. Understand transaction expiry, getLatestBlockhash RPC calls, and why slot numbers exceed block numbers by millions."
---
