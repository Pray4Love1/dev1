...
description: Understand the Avalanche Granite upgrade including ACP-181, ACP-204, and ACP-226 proposals that improve network performance and validator operations.
---
