---
title: MESC (Multi-Endpoint Shared Configuration) setup
description: Set up Multi-Endpoint Shared Configuration to manage multiple Chainstack RPC endpoints from a single config file across all your development tools.
---
