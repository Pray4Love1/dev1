...
description: Set up MetaMask, Hardhat, and the Kaia SDK to build and deploy smart contracts on the Kaia network through your Chainstack RPC node endpoints.
---
