---
title: "Monad: Querying the blockchain with JavaScript"
description: Read blockchain data from Monad using ethers.js and a Chainstack node endpoint, covering blocks, transactions, balances, and contract state queries.
---
