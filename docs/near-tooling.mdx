---
title: "NEAR tooling"
description: Set up NEAR CLI and development tools to interact with your NEAR Protocol nodes deployed on Chainstack. NEAR support is now deprecated on the platform.
---
