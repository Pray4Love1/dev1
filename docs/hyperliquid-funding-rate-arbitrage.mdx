...
description: Implement a funding rate arbitrage strategy between Hyperliquid spot and perpetual markets using Python, calculating entry sizes and expected returns.
---
