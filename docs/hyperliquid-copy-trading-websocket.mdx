...
description: Build a copy trading bot that mirrors Hyperliquid spot trades in real time using WebSocket subscriptions and the Hyperliquid Python SDK on Chainstack.
---
