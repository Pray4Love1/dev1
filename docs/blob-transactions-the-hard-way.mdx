...
description: Construct and send EIP-4844 blob transactions manually on Ethereum using ethers.js and c-kzg, covering blob encoding, commitment proofs, and gas fees.
---
