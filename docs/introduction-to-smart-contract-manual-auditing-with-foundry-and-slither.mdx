...
description: Audit smart contracts manually using Foundry for testing and Slither for static analysis to identify vulnerabilities before deploying to production.
---
