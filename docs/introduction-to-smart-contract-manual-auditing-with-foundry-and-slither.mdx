...
<CardGroup>
  <Card title="Natachi Nnamaka">
    ...
    [<Icon icon="github" iconType="brands" />](https://github.com/natachigram) [<Icon icon="twitter" iconType="brands" />](https://twitter.com/natachijs) [<Icon icon="linkedin" iconType="brands" />](https://www.linkedin.com/in/natachijs/)
  </Card>
</CardGroup>
