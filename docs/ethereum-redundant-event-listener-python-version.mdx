---
title: "Ethereum: Redundant event listener with Python"
description: Build a redundant Ethereum event listener in Python with automatic WebSocket reconnection and failover across multiple Chainstack node endpoints.
---
**TLDR**
