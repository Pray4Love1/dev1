...
description: "Understand Hyperliquid's dual signing architecture for L1 actions and EVM transactions, including EIP-712 typed data and standard Ethereum signatures."
---
