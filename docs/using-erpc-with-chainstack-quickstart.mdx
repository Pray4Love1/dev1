...
description: "Set up eRPC fault-tolerant proxy with Chainstack auto-discovery. Configure multi-chain RPC endpoints, caching, and failover using Platform API integration."
---
