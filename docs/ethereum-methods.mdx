...
| ---------------------------------------- | ------------ | ------------------------ |
| eth\_accounts                            | <Icon icon="square-check"  iconType="solid" />            | Will always return empty |
...
| eth\_simulateV1                          | <Icon icon="square-check"  iconType="solid" />            | No archive data support  |
