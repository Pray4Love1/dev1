...
description: Configure MetaMask, Hardhat, Foundry, and other tools to connect to Plasma mainnet and testnet networks using your Chainstack RPC node endpoints.
---
