...
description: Understand Chainstack node deployment modes including full, archive, elastic, dedicated, and trader node types with their capabilities and trade-offs.
---
