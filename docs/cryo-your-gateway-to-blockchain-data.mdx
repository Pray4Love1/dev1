...
description: Extract blockchain data into JSON or Parquet using cryo, a Rust CLI tool for blocks, transactions, and logs paired with Chainstack RPC endpoints.
---
