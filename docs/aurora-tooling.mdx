---
title: "Aurora tooling"
description: Set up MetaMask, Hardhat, Foundry, and other development tools to build and deploy smart contracts on Aurora through Chainstack nodes.
---
...
2. Use the `brownie networks add` command with the node endpoint:
   ...
   <CodeGroup>
     ```shell Shell
     brownie networks add Aurora ID name="NETWORK_NAME" host= YOUR_CHAINSTACK_ENDPOINT chainid=NETWORK_ID
     ```
   </CodeGroup>
