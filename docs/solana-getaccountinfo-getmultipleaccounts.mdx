---
title: "Solana: getAccountInfo vs getMultipleAccounts"
description: Compare getAccountInfo and getMultipleAccounts Solana RPC methods for efficient account data retrieval with batching strategies on Chainstack nodes.
---
