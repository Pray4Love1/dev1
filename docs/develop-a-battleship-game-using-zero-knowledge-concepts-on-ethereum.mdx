---
title: "Ethereum: Battleship game with zero-knowledge proofs"
description: Build a Battleship game on Ethereum using zero-knowledge proofs with Circom circuits and Solidity verifiers deployed through a Chainstack RPC node.
---
...
<CardGroup>
  <Card title="TobeTek">
    ...
    <br /><Icon icon="screwdriver-wrench" iconType="solid" /> Working on AI and ML projects

    <div style={{display: "flex", justifyContent: "center", gap: "12px"}}>
      <a href="https://github.com/TobeTek" style={{textDecoration: "none", borderBottom: "none"}}><Icon icon="github" iconType="brands" /></a>
      <a href="https://www.linkedin.com/in/emmanuel-katchy" style={{textDecoration: "none", borderBottom: "none"}}><Icon icon="linkedin" iconType="brands" /></a>
    </div>
  </Card>
</CardGroup>
