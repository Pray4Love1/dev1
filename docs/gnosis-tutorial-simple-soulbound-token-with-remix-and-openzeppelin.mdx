---
title: "Gnosis: Soulbound token with Remix and OpenZeppelin"
description: Create and deploy a non-transferable soulbound ERC-721 token on Gnosis Chain Chiado testnet using Remix, OpenZeppelin, and a Chainstack RPC node.
---
