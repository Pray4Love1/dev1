...
| arbtrace\_block                          | <Icon icon="square-check"  iconType="solid" />            | Pre-Nitro blocks only |
| arbtrace\_call                           | <Icon icon="square-check"  iconType="solid" />            | Pre-Nitro blocks only |
| arbtrace\_callMany                       | <Icon icon="square-check"  iconType="solid" />            | Pre-Nitro blocks only |
| arbtrace\_filter                         | <Icon icon="square-check"  iconType="solid" />            | Pre-Nitro blocks only |
| arbtrace\_get                            | <Icon icon="square-check"  iconType="solid" />            | Pre-Nitro blocks only |
| arbtrace\_replayBlockTransactions        | <Icon icon="square-check"  iconType="solid" />            | Pre-Nitro blocks only |
| arbtrace\_replayTransaction              | <Icon icon="square-check"  iconType="solid" />            | Pre-Nitro blocks only |
| arbtrace\_transaction                    | <Icon icon="square-check"  iconType="solid" />            | Pre-Nitro blocks only |
