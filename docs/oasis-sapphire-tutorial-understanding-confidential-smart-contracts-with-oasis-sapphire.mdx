...
<CardGroup>
  <Card title="Sethu Raman Omanakuttan">
    ...
    [<Icon icon="github" iconType="brands" />](https://github.com/SethuRamanOmanakuttan) [<Icon icon="twitter" iconType="brands" />](https://twitter.com/Sethu_Raman_O) [<Icon icon="linkedin" iconType="brands" />](https://www.linkedin.com/in/sethuraman-omanakuttan)
  </Card>
</CardGroup>
