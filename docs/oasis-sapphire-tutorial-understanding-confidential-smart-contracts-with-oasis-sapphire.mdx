...
description: Build confidential smart contracts on Oasis Sapphire that keep transaction data encrypted, using the ParaTime wrapper and a Chainstack RPC endpoint.
---
