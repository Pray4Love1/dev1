---
title: "Oasis Sapphire: Understanding confidential smart contracts"
description: "Learn confidential smart contracts on Oasis Sapphire with Chainstack. Compare privacy features vs Ethereum, deploy encrypted contracts, and understand end-to-end data protection."
---

**TLDR:**
* The Oasis Network is a proof-of-stake chain focused on privacy and scalability, where “ParaTimes” separate consensus and execution.
* You can deploy the same Solidity contract on both Ethereum Sepolia (fully public) and Oasis Sapphire (confidential by default).
* On Ethereum, all transaction data and storage is publicly visible, which can compromise “secret” games or auctions.
* On Oasis Sapphire, the data is end-to-end encrypted for privacy, so you can only access the parts you explicitly expose in your contract.
...
* [Chainstack account](https://console.chainstack.com/) to deploy a [reliable Oasis Sapphire RPC endpoint](https://chainstack.com/build-better-with-oasis-sapphire/)
...
1. Log in to your Chainstack account and create a <Tooltip tip="A public chain project- a project to join public networks">public chain project</Tooltip>.
...
See [Oasis Sapphire Tools: MetaMask](/docs/oasis-sapphire-tooling#metamask).
...
To get test tokens for your Ethereum Sepolia account, use the [Ethereum Sepolia Faucet](https://faucet.chainstack.com).
...
If the contract is successfully compiled, you will see a corresponding message, and the output will be stored in the newly generated `/artifacts` directory at the root of your project.
...
<CardGroup>
  <Card title="Sethu Raman Omanakuttan">
    <img src="/images/docs/u/44131280.png" alt="Sethu Raman Omanakuttan" style={{width: '80px', height: '80px', borderRadius: '50%', objectFit: 'cover', display: 'block', margin: '0 auto'}} noZoom />
    ...
    <div style={{display: "flex", justifyContent: "center", gap: "12px"}}>
      <a href="https://github.com/SethuRamanOmanakuttan" style={{textDecoration: "none", borderBottom: "none"}}><Icon icon="github" iconType="brands" /></a>
      <a href="https://twitter.com/Sethu_Raman_O" style={{textDecoration: "none", borderBottom: "none"}}><Icon icon="twitter" iconType="brands" /></a>
      <a href="https://www.linkedin.com/in/sethuraman-omanakuttan" style={{textDecoration: "none", borderBottom: "none"}}><Icon icon="linkedin" iconType="brands" /></a>
    </div>
  </Card>
</CardGroup>
