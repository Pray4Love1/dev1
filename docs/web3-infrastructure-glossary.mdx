...
description: Glossary of Web3 infrastructure terms covering zero-knowledge rollups, optimistic rollups, sidechains, RPC nodes, and blockchain scaling solutions.
---
