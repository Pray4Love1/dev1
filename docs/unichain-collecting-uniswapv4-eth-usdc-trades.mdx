...
description: Collect and decode Uniswap v4 ETH-USDC swap events on Unichain mainnet using Python event log parsing and a Chainstack Unichain RPC node endpoint.
---
