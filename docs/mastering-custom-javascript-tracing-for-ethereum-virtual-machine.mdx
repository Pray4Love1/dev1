---
title: Custom JavaScript tracing for EVM transactions
description: Write custom JavaScript tracers for the EVM debug_traceTransaction method to extract specific execution data from Ethereum transactions on Chainstack.
---
