...
<CardGroup>
  <Card title="Wuzhong Zhu">
    ...
    [<Icon icon="twitter" iconType="brands" />](https://twitter.com/wuzhongzhu) [<Icon icon="linkedin" iconType="brands" />](https://www.linkedin.com/in/wuzhong-zhu-44563589/) [<Icon icon="github" iconType="brands" />](https://github.com/wuzhong-zhu)
  </Card>
</CardGroup>
