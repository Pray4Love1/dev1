---
title: "Gnosis Chain"
description: Complete reference of supported Gnosis Chain JSON-RPC methods on Chainstack, including eth, debug, trace, and net namespace availability details.
---
