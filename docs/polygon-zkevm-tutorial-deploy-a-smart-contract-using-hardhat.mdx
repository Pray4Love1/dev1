...
<CardGroup>
  <Card title="Priyank Gupta">
    ...
    [<Icon icon="github" iconType="brands" />](https://github.com/Genesis3800) [<Icon icon="twitter" iconType="brands" />](https://twitter.com/PriyankGupta03) [<Icon icon="linkedin" iconType="brands" />](https://www.linkedin.com/in/priyank-gupta-0308/)
  </Card>
</CardGroup>
