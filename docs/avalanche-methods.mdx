...
| platform.getAllValidatorsAt   | <Icon icon="square-check"  iconType="solid" />            |         |
...
Available on all chains (P-chain, X-chain, C-chain).

| Method                        | Availability | Comment |
| ----------------------------- | ------------ | ------- |
| proposervm.GetCurrentEpoch    | <Icon icon="square-check"  iconType="solid" />            |         |
| proposervm.GetProposedHeight  | <Icon icon="square-check"  iconType="solid" />            |         |
