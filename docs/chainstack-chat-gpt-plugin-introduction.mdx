---
title: "Chainstack ChatGPT plugin overview"
description: Use the Chainstack ChatGPT plugin to query blockchain data through natural language, fetching balances, transactions, and token info conversationally.
---
