...
description: Add and manage organization identities in the Chainstack vault for Hyperledger Fabric and Corda consortium networks. Now deprecated on the platform.
---
