---
title: "Solana: Listen to pump.fun mints via logsSubscribe"
description: Capture newly created pump.fun tokens in real time by subscribing to Solana program logs with logsSubscribe and decoding mint event data.
---
