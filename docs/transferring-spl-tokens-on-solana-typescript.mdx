...
description: "Transfer SPL tokens on Solana using TypeScript and @solana/web3.js. Create associated token accounts, handle priority fees, and send transactions with Chainstack."
---
