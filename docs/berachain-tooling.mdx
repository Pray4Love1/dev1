---
title: "Berachain tooling"
description: Set up MetaMask, Hardhat, Foundry, and development tools to build and deploy smart contracts on Berachain through your Chainstack RPC node endpoints.
---

Get started with a [reliable Berachain RPC endpoint](https://chainstack.com/build-better-with-berachain/) to use the tools below.
