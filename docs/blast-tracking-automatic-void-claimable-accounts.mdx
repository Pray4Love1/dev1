...
description: Track Blast automatic void and claimable yield accounts on-chain using contract calls and event monitoring through a Chainstack Blast RPC node endpoint.
---
