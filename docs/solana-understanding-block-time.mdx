...
description: Understand Solana block time mechanics including slot duration, leader schedules, skip rates, and how they affect transaction confirmation latency.
---
