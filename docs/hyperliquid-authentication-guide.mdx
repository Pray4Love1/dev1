...
description: Configure Hyperliquid API authentication with wallet private keys and API wallet delegation for secure programmatic trading through Chainstack endpoints.
---
