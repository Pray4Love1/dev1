...
description: Query balances, read contracts, and interact with Ethereum and EVM-compatible blockchains through the EVM MCP server for AI-assisted development.
---
