---
title: Track token supply with subgraphs on Chainstack
description: "Track ERC-20 token total supply across millions of blocks with subgraphs. Index mint/burn events, deploy to Chainstack, and query historical data efficiently."
---
...
<CardGroup>
  <Card title="Kirill Balakhonov">
    <img src="/images/docs/u/44712112.png" alt="Kirill Balakhonov" style={{width: '80px', height: '80px', borderRadius: '50%', objectFit: 'cover', display: 'block', margin: '0 auto'}} noZoom />
    ...
    <div style={{display: "flex", justifyContent: "center", gap: "12px"}}>
      <a href="https://github.com/balakhonoff" style={{textDecoration: "none", borderBottom: "none"}}><Icon icon="github" iconType="brands" /></a>
      <a href="https://twitter.com/balakhonoff" style={{textDecoration: "none", borderBottom: "none"}}><Icon icon="twitter" iconType="brands" /></a>
      <a href="https://www.linkedin.com/in/kirill-balakhonov/" style={{textDecoration: "none", borderBottom: "none"}}><Icon icon="linkedin" iconType="brands" /></a>
    </div>
  </Card>
</CardGroup>
