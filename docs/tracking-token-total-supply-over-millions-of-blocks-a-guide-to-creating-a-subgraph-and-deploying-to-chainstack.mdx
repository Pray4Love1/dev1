...
<CardGroup>
  <Card title="Kirill Balakhonov">
    ...
    [<Icon icon="github" iconType="brands" />](https://github.com/balakhonoff) [<Icon icon="twitter" iconType="brands" />](https://twitter.com/balakhonoff) [<Icon icon="linkedin" iconType="brands" />](https://www.linkedin.com/in/kirill-balakhonov/)
  </Card>
</CardGroup>
