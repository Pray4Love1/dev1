...
| eth\_callBundle                          | <Icon icon="square-check" iconType="solid" />             |                               |
...
| eth\_sendTransaction                     | <Icon icon="square-check" iconType="solid" />             |                               |
| eth\_sign                                | <Icon icon="square-check" iconType="solid" />             |                               |
| eth\_signTransaction                     | <Icon icon="square-check" iconType="solid" />             |                               |
| eth\_signTypedData                       | <Icon icon="square-check" iconType="solid" />             |                               |
| eth\_simulateV1                          | <Icon icon="square-check" iconType="solid" />             |                               |
| eth\_submitHashrate                      | <Icon icon="square-check" iconType="solid" />             |                               |
| eth\_subscribe                           | <Icon icon="square-check" iconType="solid" />             | WebSocket only                |
| eth\_syncing                             | <Icon icon="square-check" iconType="solid" />             |                               |
| eth\_uninstallFilter                     | <Icon icon="square-check" iconType="solid" />             |                               |
| eth\_unsubscribe                         | <Icon icon="square-check" iconType="solid" />             | WebSocket only                |
...
| debug\_getRawTransactions                | <Icon icon="square-check" iconType="solid" />             |                               |
| debug\_intermediateRoots                 | <Icon icon="square-check" iconType="solid" />             |                               |
| debug\_preimage                          | <Icon icon="square-check" iconType="solid" />             |                               |
| debug\_setHead                           | <Icon icon="square-check" iconType="solid" />             |                               |
...
| trace\_blockOpcodeGas                    | <Icon icon="square-check" iconType="solid" />             |                               |
...
| trace\_transactionOpcodeGas              | <Icon icon="square-check" iconType="solid" />             |                               |
...
| txpool\_content                          | <Icon icon="xmark" iconType="solid" />                    | Available on dedicated nodes  |
| txpool\_contentFrom                      | <Icon icon="xmark" iconType="solid" />                    | Available on dedicated nodes  |
| txpool\_inspect                          | <Icon icon="xmark" iconType="solid" />                    | Available on dedicated nodes  |
| txpool\_status                           | <Icon icon="xmark" iconType="solid" />                    | Available on dedicated nodes  |
