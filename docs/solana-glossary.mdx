...
description: Key Solana terms and concepts including associated token accounts, program derived addresses, compute units, priority fees, and transaction structure.
---
