...
description: Use durable nonces on Solana for offline signing, delayed transaction submission, and multi-sig workflows that need transactions to stay valid beyond the 150-slot blockhash window.
---
