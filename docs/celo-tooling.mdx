---
title: "Celo tooling"
description: Set up MetaMask, Hardhat, Foundry, and other development tools to build and deploy smart contracts on Celo through your Chainstack RPC node endpoints.
---

Get started with a [reliable Celo RPC endpoint](https://chainstack.com/build-better-with-celo/) to use the tools below.
