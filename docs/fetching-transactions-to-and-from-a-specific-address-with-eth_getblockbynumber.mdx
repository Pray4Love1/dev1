---
title: Fetch address transactions with eth_getBlockByNumber
description: Filter transactions by address using eth_getBlockByNumber to scan Ethereum blocks and extract all incoming and outgoing transfers via a Chainstack node.
---
