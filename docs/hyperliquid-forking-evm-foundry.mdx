...
description: Fork the Hyperliquid EVM chain locally using Foundry Anvil for offline smart contract development, testing, and debugging with a Chainstack endpoint.
---
