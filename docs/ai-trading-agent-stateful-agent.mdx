...
description: Build a stateful AI trading agent that maintains context across analysis sessions for consistent blockchain market tracking and signal generation.
---
