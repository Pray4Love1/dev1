...
description: "Learn subgraph schema design with entities, relationships, and data types. Understand @entity, immutable vs mutable, and @derivedFrom for blockchain indexing."
---
