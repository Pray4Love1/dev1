---
title: "Flashblocks on Base: 200ms preconfirmations"
description: Enable Flashblocks on Base through Chainstack for 200ms transaction preconfirmations, making your dApp experience up to 10x faster on the network.
---
