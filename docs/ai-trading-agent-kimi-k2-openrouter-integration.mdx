...
description: Integrate Moonshot Kimi-K2 through OpenRouter into your AI trading agent for cost-effective blockchain market analysis with multi-model support.
---
