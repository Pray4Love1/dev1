...
description: Tokenize real-world assets on Ethereum using the Embark framework and a Chainstack node to deploy and manage ERC-20 asset-backed token contracts.
---
