---
title: "Bitcoin tooling"
description: Connect to your Chainstack Bitcoin node using JSON-RPC API with curl or Postman, and set up Bitcoin Core for direct blockchain interaction.
---
