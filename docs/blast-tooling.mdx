---
title: "Blast tooling"
description: Set up MetaMask, Hardhat, Foundry, and other development tools to build and deploy smart contracts on Blast through your Chainstack RPC nodes.
---

Get started with a [reliable Blast RPC endpoint](https://chainstack.com/build-better-with-blast/) to use the tools below.
