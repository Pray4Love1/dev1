---
title: "ethers.js ChainstackProvider: Multi-chain balance checker"
description: Build a multi-chain wallet balance aggregator using ethers.js ChainstackProvider to query balances across Ethereum, Polygon, and BNB Smart Chain.
---
