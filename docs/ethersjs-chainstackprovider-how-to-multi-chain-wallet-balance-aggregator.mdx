...
description: "Build multi-chain wallet balance aggregator with ethers.js ChainstackProvider and Next.js. Connect to Ethereum, Polygon, Arbitrum, BNB Smart Chain with Chainstack nodes."
---
