...
description: Create and deploy a multi-signature wallet contract on Fuse using Hardhat that requires multiple owner confirmations for withdrawals. Now deprecated.
---
