...
description: Build, deploy, and upgrade a NEAR smart contract using near-sdk-rs and NEAR CLI through a Chainstack node. NEAR support is now deprecated on Chainstack.
---
