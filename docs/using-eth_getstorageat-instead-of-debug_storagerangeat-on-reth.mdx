---
title: eth_getStorageAt vs debug_storageRangeAt on Reth
description: Work around the unsupported debug_storageRangeAt method in Reth by using eth_getStorageAt with known storage slot positions for contract state access.
---
