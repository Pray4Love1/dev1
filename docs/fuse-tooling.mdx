---
title: "Fuse tooling"
description: Set up MetaMask, Hardhat, and Foundry to build and deploy smart contracts on Fuse through your Chainstack nodes. Fuse support is now deprecated.
---
