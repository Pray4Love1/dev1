---
title: Subgraph for upgradeable proxy contracts guide
description: Index upgradeable proxy contracts with subgraphs by configuring data sources to track implementation changes and decode events across contract versions.
---
