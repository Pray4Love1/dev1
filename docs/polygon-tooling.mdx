---
title: "Polygon tooling"
description: Set up MetaMask, Hardhat, Foundry, and development tools to build and deploy smart contracts on Polygon PoS through your Chainstack RPC node endpoints.
---

Get started with a [reliable Polygon RPC endpoint](https://chainstack.com/build-better-with-polygon/) to use the tools below.
