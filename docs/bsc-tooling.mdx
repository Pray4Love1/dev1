...
description: Set up MetaMask, Hardhat, Foundry, and BNB Smart Chain client to build and deploy contracts on BSC through your Chainstack RPC node endpoints.
---
