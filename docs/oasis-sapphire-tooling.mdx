...
description: Set up MetaMask, Hardhat, and the Sapphire ParaTime wrapper to build confidential smart contracts on Oasis Sapphire through Chainstack endpoints.
---
