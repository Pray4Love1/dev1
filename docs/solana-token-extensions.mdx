...
description: Understand Token Extensions on Solana — the Token-2022 program that adds transfer fees, confidential transfers, metadata, soulbound tokens, and more to SPL tokens via Chainstack nodes.
---
