...
description: Test Solana programs in-process with LiteSVM — 10–100× faster than solana-test-validator, with time-travel, compute budgets, feature-gate control, and native Rust, TypeScript, and Python bindings.
---
