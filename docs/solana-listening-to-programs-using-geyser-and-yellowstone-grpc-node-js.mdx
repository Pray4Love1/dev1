---
title: "Solana: Geyser and Yellowstone gRPC in Node.js"
description: Stream real-time Solana transactions over gRPC using the Yellowstone client in Node.js with a Chainstack Geyser-enabled node for low-latency program data.
---
