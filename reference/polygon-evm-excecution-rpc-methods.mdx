...
description: "The executing transactions methods provide developers with a flexible set of tools for interacting with the Polygon network."
...
Executing and simulating transactions on the Polygon blockchain can be done by using the following methods:

<CardGroup>
<Card title="eth_call" href="/reference/ethcall" icon="angle-right" iconType="solid" horizontal />
<Card title="eth_sendRawTransaction" href="/reference/sendrawtransaction" icon="angle-right" iconType="solid" horizontal />
</CardGroup>
