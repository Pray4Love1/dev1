...
* `object` — a block object, or `null` when no block was found.
  ...
  + `totaldifficulty` — `null`. This field is obsolete as it was used during Ethereum's Proof of Work (PoW) era. As an Ethereum L2, Polygon zkEVM inherits Ethereum's consensus mechanism and this value is no longer relevant.
