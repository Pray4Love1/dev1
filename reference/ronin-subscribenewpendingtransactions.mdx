---
title: "eth_subscribe(\"newPendingTransactions\") | Ronin"
description: "Ronin API method that allows developers to receive real-time notifications regarding new pending transactions on the Ronin blockchain. The application will receive notifications whenever new pending transactions are identified."
---
...
The `eth_subscribe("newPendingTransactions")` method in Ronin is used to subscribe to the network and receive real-time updates on all new pending transactions on the network. This can be useful in a variety of real-world scenarios, including:
