---
title: eth_estimateGas | Aurora
openapi: /openapi/aurora_node_api/eth_estimateGas.json POST /6df1a1b3061097e66349993a96b8e535
---
...
print(web3.eth.estimate_gas({"from":"0x8B0003B2AA1699Ca0Dd269ceda5bC26757a86FbC","to":"0xbe0eb53f46cd790cd13851d5eff43d12404d33e8"}, "latest" ))  
```
</CodeGroup>
