...
openapi: /openapi/fantom_node_api/eth_estimateGas.json POST /4ab982aa70a7baead515ffdb5915df3f
---

Fantom API method that returns an estimate of gas units needed for a given transaction.
