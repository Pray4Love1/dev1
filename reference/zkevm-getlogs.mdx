---
title: eth_getLogs | zkEVM
openapi: /openapi/polygon_zkevm_node_api/eth_getLogs.json POST /942aad90bb6a082676497030b81e40ba
---

Polygon zkEVM API method that returns an array of all logs that match a given filter object. Logs are records of smart contract-generated events on the network and contain valuable information about transactions and smart contract interactions.
...
The following examples retrieve the logs of the Transfer event from the [WETH token](https://zkevm.polygonscan.com/address/0x4F9A0e7FD2Bf6067db6994CF12E4495Df938E6e9#readContract) smart contract on Ethereum.
