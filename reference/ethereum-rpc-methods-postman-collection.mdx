...
description: "Here you will have access to a Postman collection to test the Ethereum API methods using your Ethereum Chainstack endpoint."
---
...
<Step>
After the collection is set up, select a method to test, for example, `eth_chainId`.
</Step>
<Step>
