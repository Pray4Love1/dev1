---
title: web3_clientVersion | zkEVM
openapi: /openapi/polygon_zkevm_node_api/web3_clientVersion.json POST /942aad90bb6a082676497030b81e40ba
---

Polygon zkEVM API method that returns the client type and version running on the zkEVM node. This information can be useful to developers to verify that a node they are connecting to is compatible with their needs.
