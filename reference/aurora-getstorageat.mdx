---
title: eth_getStorageAt | Aurora
openapi: /openapi/aurora_node_api/eth_getStorageAt.json POST /6df1a1b3061097e66349993a96b8e535
---
...
The following example returns the storage value at slot `2` from the [WETH Token on the Aurora mainnet](https://explorer.aurora.dev/token/0xC9BdeEd33CD01541e1eeD10f90519d2C06Fe3feB). In this case, this is the decimals value.
...
async function getstorage(address, slot, block) {
 ...
 getstorage("0xC9BdeEd33CD01541e1eeD10f90519d2C06Fe3feB", 2, "latest" )
```
...
storage = web3.eth.get_storage_at("0xC9BdeEd33CD01541e1eeD10f90519d2C06Fe3feB", 2, "latest")
