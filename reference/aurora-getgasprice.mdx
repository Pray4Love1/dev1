---
title: eth_gasPrice | Aurora
openapi: /openapi/aurora_node_api/eth_gasPrice.json POST /6df1a1b3061097e66349993a96b8e535
---

Aurora API method that returns the current gas base fee of the network. The gas price is the quantity of the native token the transaction's sender must pay per unit of gas consumed. The value returned is in Wei.
