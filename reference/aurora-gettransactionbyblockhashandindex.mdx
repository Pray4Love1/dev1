---
title: eth_getTransactionByBlockHashAndIndex | Aurora
openapi: /openapi/aurora_node_api/eth_getTransactionByBlockHashAndIndex.json POST
  /6df1a1b3061097e66349993a96b8e535
---

Aurora API method that retrieves information about a specific transaction based on the block hash and the transaction index within the block. This information can be used to track transactions, debug issues, analyze data, and build decentralized applications on the Cronos blockchain.
...
const getTransaction = async (blockHash, index) => {
  ...
  getTransaction("0x398de42536397b8885c23b286ebc4a4e8b7f5a2aa0690d712abf1873de815fba", "0x0");
```
...
print(web3.eth.get_transaction_by_block("0x398de42536397b8885c23b286ebc4a4e8b7f5a2aa0690d712abf1873de815fba", 0))
```
</CodeGroup>
