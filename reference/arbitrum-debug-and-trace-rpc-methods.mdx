...
description: "Arbitrum provides debug_* methods for tracing and inspecting post-Nitro blocks (>= 22,207,815) and arbtrace_* methods for tracing pre-Nitro blocks. The trace_* namespace is not supported."
