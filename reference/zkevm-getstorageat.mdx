---
title: eth_getStorageAt | zkEVM
openapi: /openapi/polygon_zkevm_node_api/eth_getStorageAt.json POST /942aad90bb6a082676497030b81e40ba
---
...
The following example returns the storage value at slot `0` from the [WETH Token on the Polygon zkEVM mainnet](https://zkevm.polygonscan.com/address/0x4F9A0e7FD2Bf6067db6994CF12E4495Df938E6e9#code). In this case, this is the token's name.
