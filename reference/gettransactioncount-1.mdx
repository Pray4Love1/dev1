---
title: eth_getTransactionCount | zkEVM
openapi: /openapi/polygon_zkevm_node_api/eth_getTransactionCount.json POST /942aad90bb6a082676497030b81e40ba
---

Polygon zkEVM API method that returns the number of transactions sent from an address at the selected block. This value is also called `nonce`; it is an important piece of information, especially to ensure that a transaction is not sent twice.
...
getTransactionsCount("0x67063E37BF7192745490D7d75c9ffdECC2846100", 'latest')
```
...
const getNonce = async (address, blockId) => {
  ...
  getNonce("0x67063E37BF7192745490D7d75c9ffdECC2846100", "latest")
```
...
print(web3.eth.get_transaction_count("0x67063E37BF7192745490D7d75c9ffdECC2846100", "latest")) 
```
</CodeGroup>
