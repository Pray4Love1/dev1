---
title: eth_sendRawTransaction | Aurora
openapi: /openapi/aurora_node_api/eth_sendRawTransaction.json POST /6df1a1b3061097e66349993a96b8e535
---

Aurora API method that allows submitting a signed transaction to the network. Once a transaction is signed, you can use the `eth_sendRawTransaction` method to submit the signed transaction to the Cronos network for processing.
