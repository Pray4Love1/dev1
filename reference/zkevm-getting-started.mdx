...
The zkEVM node API section only covers the new methods introduced under the `zkevm_` namespace, but you can find a list of all EVM-compatible methods by referring to the [Chainstack’s Polygon API reference](/reference/polygon-getting-started) and in [Polygon Hermez’s docs](https://github.com/0xPolygonHermez/zkevm-node/blob/develop/docs/json-rpc-endpoints.md).
