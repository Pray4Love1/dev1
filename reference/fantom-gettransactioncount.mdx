---
title: eth_getTransactionCount | Fantom
openapi: /openapi/fantom_node_api/eth_getTransactionCount.json POST /4ab982aa70a7baead515ffdb5915df3f
---
...
getTransactionsCount("0x18443ddbc5cd7Fb2F07551b54A37254F06819464", 'latest')
```
...
const getNonce = async (address, blockId) => {
  ...
  getNonce("0x18443ddbc5cd7Fb2F07551b54A37254F06819464", "latest")
```
...
print(web3.eth.get_transaction_count("0x18443ddbc5cd7Fb2F07551b54A37254F06819464", "latest")) 
```
</CodeGroup>
