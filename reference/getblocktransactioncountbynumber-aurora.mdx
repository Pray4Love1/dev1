---
title: eth_getBlockTransactionCountByNumber | Aurora
openapi: /openapi/aurora_node_api/eth_getBlockTransactionCountByNumber.json POST /6df1a1b3061097e66349993a96b8e535
---
