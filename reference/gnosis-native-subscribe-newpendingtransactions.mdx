---
title: 'eth_subscribe ("newPendingTransactions") | Gnosis'
description: "Gnosis Chain API method that allows developers to receive real-time notifications regarding new pending transactions on the Gnosis Chain. The application will receive notifications whenever new pending transactions are identified."
---
