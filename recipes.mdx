---
title: "Recipes"
description: Ready-to-use code snippets for common blockchain development tasks, covering Ethereum, Solana, Polygon, and other networks with Chainstack endpoints.
---
