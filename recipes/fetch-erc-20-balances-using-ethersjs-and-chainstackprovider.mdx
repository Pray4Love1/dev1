...
description: Fetch ERC-20 token balances using ethers.js ChainstackProvider to call smart contract read functions like balanceOf and decimals through Chainstack nodes.
---
