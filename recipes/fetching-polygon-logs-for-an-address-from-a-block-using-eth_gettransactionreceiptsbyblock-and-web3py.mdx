---
title: Fetch Polygon logs with eth_getTransactionReceipts
description: Fetch Polygon event logs for a specific address using eth_getTransactionReceiptsByBlock and web3.py to filter transaction receipts from any block.
---
