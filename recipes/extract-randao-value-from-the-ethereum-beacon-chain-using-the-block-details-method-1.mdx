---
title: Extract RANDAO from Ethereum Beacon Chain blocks
description: Extract the RANDAO random value from Ethereum Beacon Chain block details using JavaScript and Axios for on-chain randomness verification and analysis.
---
