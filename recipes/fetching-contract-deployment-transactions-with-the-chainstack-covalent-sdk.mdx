---
title: Fetch contract deployments with Chainstack Covalent SDK
description: Query the Covalent SDK through Chainstack Marketplace to retrieve a list of smart contracts deployed by a specific blockchain address with transaction data.
---
