---
title: Identify if a block is in the main chain or forked
description: Check whether an Ethereum block is part of the canonical chain or was orphaned during a fork using block hash comparison through a Chainstack RPC node.
---
