---
title: Create a .env file with Chainstack endpoints in JS
description: Generate a .env file listing all your Chainstack node endpoints automatically using the Platform API and JavaScript for streamlined local development setup.
---
