---
title: Create a .env file with Chainstack endpoints in Python
description: Generate a .env file listing all your Chainstack node endpoints automatically using the Platform API and Python for streamlined local development setup.
