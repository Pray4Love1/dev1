...
description: Send SOL transactions programmatically using solana-web3.js with a Chainstack Solana node, covering keypair generation, transfers, and transaction signing.
---
